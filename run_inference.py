...
def load_model(base_model_path, audio_tower_path, device):
    # load based model
    ...
    audio_processor = WhisperProcessor.from_pretrained(audio_tower_path, torch_dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--audio_tower_path', type=str, default='assets/models/whisper')
